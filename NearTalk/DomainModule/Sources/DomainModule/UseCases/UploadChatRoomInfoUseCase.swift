...
public protocol UploadChatRoomInfoUseCase {
...
public final class DefaultUploadChatRoomInfoUseCase: UploadChatRoomInfoUseCase {
    private let mediaRepository: MediaRepository
    private let chatRoomRepository: ChatRoomListRepository
    
    public init(mediaRepository: MediaRepository, chatRoomRepository: ChatRoomListRepository) {
        self.mediaRepository = mediaRepository
        self.chatRoomRepository = chatRoomRepository
    }
    
    public func uploadImage(_ imageData: Data) -> Single<String> {
        self.mediaRepository.uploadImage(imageData)
    }
    
    public func createChatRoom(_ chatRoom: ChatRoom) -> Completable {
